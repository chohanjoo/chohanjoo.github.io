...
![k8s_master_node](/assets/image/k8s_master_node.png)
...
2. Pod 내에 배포된 컨테이너 간에는 디스크 볼륨을 공유할 수 있다.
   ...
   ![k8s_pod](/assets/image/k8s_pod.png)
...
![k8s_service](/assets/image/k8s_service.png)
...
![k8s_rc](/assets/image/k8s_rc.png)
